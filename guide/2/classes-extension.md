...
Our classes can have various methods that a programmer may use to interact with it. Here is an example of your typical method declaration, taken from the [previous](/guide/2/classes-objects-packages.md) section.
```java
...
- Access modifiers — such as `public` and `private`, which is discussed in a later section, over [here](/guide/2/oop.md#access-modifiers).
...
- `public` — this is the method's access modifier. Access modifiers are discussed in a later section, over [here](/guide/2/oop.md#access-modifiers).
...
Let's go back to our `CharacterCard` class from the [**Classes, Objects and Packages**](/guide/2/classes-objects-packages.md) section.
```java
